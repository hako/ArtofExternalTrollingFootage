#---------------------------------------------------------------------------------
# Makefile For the Art of External Trolling using Nightfox's Lib.
#---------------------------------------------------------------------------------
...
GAME_TITLE	    :=	The Art of External Trolling: The Footage
GAME_SUBTITLE1	:=	HakoByte
GAME_SUBTITLE2	:=	www.hakobaito.co.uk
...
LIBS	:= $(CURDIR)/../lib/viDSnips.a $(LIBS)
